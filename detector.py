...
ap.add_argument('-c', '--config', 
                help = 'path to yolo config file', default='D:\\AI\\Stairs\\custom\\yolov3-tiny.cfg')
ap.add_argument('-w', '--weights', 
                help = 'path to yolo pre-trained weights', default='D:\\AI\\Stairs\\custom\\yolov3-tiny_last.weights')
ap.add_argument('-cl', '--classes', 
                help = 'path to text file containing class names',default='D:\\AI\\Stairs\\custom\\objects.names')
args = ap.parse_args()
...
while cv2.waitKey(1) < 0:
    ...
    cv2.putText(image, label, (0, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0))
